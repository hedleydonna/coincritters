...
- `is_savings?`: Returns whether this is a savings envelope (delegated to spending category).
...
- `percent_used`: Returns the percentage of allotted amount that has been spent (integer, rounded).
...
# => #<Envelope id: 1, monthly_budget_id: 1, spending_category_id: 1, ...>
...
envelope.spent_percentage  # => 64.1
...
# => #<Envelope ... errors: {:spending_category=>["has already been taken"]}>
